...
var precedences = (_precedences = {}, _defineProperty(_precedences, token.EQ, EQUALS), _defineProperty(_precedences, token.NOT_EQ, EQUALS), _defineProperty(_precedences, token.LT, LESSGREATER), _defineProperty(_precedences, token.GT, LESSGREATER), _defineProperty(_precedences, token.PLUS, SUM), _defineProperty(_precedences, token.MINUS, SUM), _defineProperty(_precedences, token.SLASH, PRODUCT), _defineProperty(_precedences, token.ASTERISK, PRODUCT), _defineProperty(_precedences, token.LPAREN, CALL), _defineProperty(_precedences, token.LBRACKET, INDEX), _precedences);
...
var Parser = function () {
  ...
  _createClass(Parser, [{
    ...
    value: function parseExpressionList(end) {
      var list = [];
    ...
    value: function parseArrayLiteral() {
      var array = new ast.ArrayLiteral(this.curToken);
    ...
    key: 'parseIndexExpression',
    value: function parseIndexExpression(left) {
      this.nextToken();
      var index = this.parseExpression(LOWEST);
    ...
    key: 'parseHashLiteral',
    value: function parseHashLiteral() {
      var hash = new ast.HashLiteral(this.curToken);
